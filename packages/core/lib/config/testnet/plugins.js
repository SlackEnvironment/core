module.exports = {
  ...
  '@slackenvironment/core-database': {
    snapshots: `${process.env.SLACK_PATH_DATA}/snapshots/${process.env.SLACK_NETWORK_NAME}`
  },
  '@slackenvironment/core-database-sequelize': {
    dialect: 'sqlite',
    storage: process.env.SLACK_DB_STORAGE || `${process.env.SLACK_PATH_DATA}/database/${process.env.SLACK_NETWORK_NAME}_.sqlite`,
    ...
    // database: process.env.SLACK_DB_DATABASE || 'slack_testnet',
  ...
  '@slackenvironment/core-webhooks': {
    ...
    database: {
      dialect: 'sqlite',
      storage: `${process.env.SLACK_PATH_DATA}/database/${process.env.SLACK_NETWORK_NAME}/webhooks.sqlite`,
      logging: process.env.SLACK_DB_LOGGING
    },
    server: {
