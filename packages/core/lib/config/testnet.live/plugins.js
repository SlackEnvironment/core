module.exports = {
  ...
  '@slackenvironment/core-logger-winston': {
    transports: {
      ...
      dailyRotate: {
        options: {
          filename: process.env.SLACK_LOG_FILE || `${process.env.SLACK_PATH_DATA}/logs/core/${process.env.SLACK_NETWORK_NAME}.live/%DATE%.log`,
  ...
  '@slackenvironment/core-database': {
    snapshots: `${process.env.SLACK_PATH_DATA}/${process.env.SLACK_NETWORK_NAME}.live/snapshots`
  },
  '@slackenvironment/core-database-sequelize': {
    dialect: 'sqlite',
    storage: process.env.SLACK_DB_STORAGE || `${process.env.SLACK_PATH_DATA}/database/${process.env.SLACK_NETWORK_NAME}.live.sqlite`,
  ...
  '@slackenvironment/core-p2p': {
    ...
    port: process.env.SLACK_P2P_PORT || 4000,
    whitelist: ['127.0.0.1', '::ffff:127.0.0.1', '192.168.*']
  },
  ...
  '@slackenvironment/core-api': {
    ...
    port: process.env.SLACK_API_PORT || 4003,
    whitelist: ['*']
  },
  '@slackenvironment/core-webhooks': {
    ...
    database: {
      dialect: 'sqlite',
      storage: `${process.env.SLACK_PATH_DATA}/database/${process.env.SLACK_NETWORK_NAME}.live/webhooks.sqlite`,
      logging: process.env.SLACK_DB_LOGGING
    },
    server: {
