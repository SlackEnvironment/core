module.exports = {
  ...
  '@slackenvironment/core-logger-winston': {
    transports: {
      ...
      dailyRotate: {
        options: {
          filename: process.env.SLACK_LOG_FILE || `${process.env.SLACK_PATH_DATA}/logs/core/${process.env.SLACK_NETWORK_NAME}.2/%DATE%.log`,
  ...
  '@slackenvironment/core-database': {
    snapshots: `${process.env.SLACK_PATH_DATA}/${process.env.SLACK_NETWORK_NAME}.2/snapshots`
  },
  '@slackenvironment/core-database-sequelize': {
    dialect: 'sqlite',
    storage: process.env.SLACK_DB_STORAGE || `${process.env.SLACK_PATH_DATA}/database/${process.env.SLACK_NETWORK_NAME}.2.sqlite`,
    ...
    // database: process.env.SLACK_DB_DATABASE || 'slack_testnet2',
  ...
  '@slackenvironment/core-p2p': {
    ...
    port: process.env.SLACK_P2P_PORT || 4202,
  ...
  '@slackenvironment/core-api': {
    ...
    port: process.env.SLACK_API_PORT || 4203,
    whitelist: ['*']
  },
  '@slackenvironment/core-webhooks': {
    ...
    database: {
      dialect: 'sqlite',
      storage: `${process.env.SLACK_PATH_DATA}/database/${process.env.SLACK_NETWORK_NAME}.2/webhooks.sqlite`,
      logging: process.env.SLACK_DB_LOGGING
    },
    server: {
  ...
  '@slackenvironment/core-graphql': {
    ...
    port: process.env.SLACK_GRAPHQL_PORT || 4205,
    path: '/graphql',
    graphiql: true
  },
