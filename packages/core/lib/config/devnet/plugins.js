module.exports = {
  ...
  '@slackenvironment/core-database-sequelize': {
    // dialect: 'sqlite',
    // storage: process.env.SLACK_DB_STORAGE || `${process.env.SLACK_PATH_DATA}/database/${process.env.SLACK_NETWORK_NAME}10.sqlite`,
    ...
    database: process.env.SLACK_DB_DATABASE || 'slack_devnet',
