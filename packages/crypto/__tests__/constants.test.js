...
describe('Constants', () => {
  it('slacktoshi is valid', () => {
    expect(constants.SLACKTOSHI).toBeDefined()
    expect(constants.SLACKTOSHI).toBe(100000000)
  })
  ...
  it('configurations are defined', () => {
    ...
    expect(constants.CONFIGURATIONS.SLACK.MAINNET).toBeDefined()
    expect(constants.CONFIGURATIONS.SLACK.MAINNET).toBeObject()

    expect(constants.CONFIGURATIONS.SLACK.DEVNET).toBeDefined()
    expect(constants.CONFIGURATIONS.SLACK.DEVNET).toBeObject()
  })
})
