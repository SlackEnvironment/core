...
const { outlookTable } = require('../constants').CONFIGURATIONS.SLACK.MAINNET
...
/**
 * TODO copy some parts to SlackDocs
 ...
 *   - totalAmount (in slacktoshi)
 *   - totalFee (in slacktoshi)
 *   - reward (in slacktoshi)
