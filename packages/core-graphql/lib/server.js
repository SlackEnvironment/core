...
const logger = require('@slackenvironment/core-container').resolvePlugin('logger')
...
module.exports = async (config) => {
   ...
   * our own parameters.
   * The bulk of the Slack logic for GraphQL is rooted in the
   * schema module.
   */
   ...
   * (@slackenvironment/core-container).resolvePlugin('graphql')
   */
  try {
    await server.start()
